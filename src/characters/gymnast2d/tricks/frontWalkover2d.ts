 ...
 * the other tricks — "graceful," not powerful. RiggedGymnastFigure's
 * head swaps to a real back-of-head view partway through root's
 * rotation (see poseUtils2d.ts's applyPose2D).
 */
