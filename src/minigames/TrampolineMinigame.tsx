...
export function TrampolineMinigame() {
  ...
  return (
    <div className="minigame">
      <TrickPicker apparatusId="trampoline" selectedTrickId={trickId} onSelect={setTrickId} />

      <div className="minigame__stage">
        {phase === "ready" && (
          <div className="minigame__prompt">
            <p className="minigame__hint">Tap BOUNCE! at the top of each jump!</p>
